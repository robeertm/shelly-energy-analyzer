...
### Docs
- **README:** New "Maintenance via CI" section — changes are requested via GitHub issue and deploy automatically to the reference VM, explicitly without cutting a new release.
