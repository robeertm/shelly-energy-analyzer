...
class CoreMixin:
    ...
    def _build_sync_tab(self) -> None:
            ...
            self._traffic_tree.column("#0", width=0, stretch=False)
            ...
            self._traffic_tree.column("cat", width=50, minwidth=50, stretch=True, anchor="w")
            self._traffic_tree.column("requests", width=30, minwidth=30, stretch=True, anchor="center")
            self._traffic_tree.column("received", width=40, minwidth=40, stretch=True, anchor="e")
            self._traffic_tree.column("sent", width=40, minwidth=40, stretch=True, anchor="e")
            ...
            self._traffic_tree.pack(side="left", fill="both", expand=True)
