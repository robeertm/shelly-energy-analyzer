...
class CoreMixin:
    ...
    def _build_sync_tab(self) -> None:
            ...
            self._traffic_tree.column("cat", width=160, minwidth=100, stretch=True, anchor="w")
            self._traffic_tree.column("requests", width=80, minwidth=60, stretch=True, anchor="center")
            self._traffic_tree.column("received", width=100, minwidth=70, stretch=True, anchor="e")
            self._traffic_tree.column("sent", width=100, minwidth=70, stretch=True, anchor="e")
