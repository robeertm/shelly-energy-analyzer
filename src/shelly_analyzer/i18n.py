...
_I18N.setdefault("es", {}).update({
    ...
    "settings.email.from_address": "Dirección de envío",
    "settings.email.use_tls": "TLS/STARTTLS",
    "settings.email.recipients": "Destinatarios (separados por coma)",
    "settings.email.alarm_enabled": "Enviar en alarmas",
    "settings.email.daily_summary_enabled": "Informe diario",
    "settings.email.daily_summary_time": "Hora diaria (HH:MM)",
    "settings.email.daily_send_now": "Enviar ahora",
    "settings.email.monthly_summary_enabled": "Informe mensual",
    "settings.email.monthly_summary_time": "Hora mensual (HH:MM)",
    "settings.email.monthly_send_now": "Enviar ahora",
    "settings.email.test": "Enviar prueba",
    "settings.email.hint": "Los informes diarios/mensuales se envían como archivos PDF adjuntos.",
...
_I18N.setdefault("fr", {}).update({
    ...
    "settings.email.smtp_server": "Serveur SMTP",
    "settings.email.smtp_port": "Port",
    "settings.email.smtp_user": "Nom d'utilisateur",
    "settings.email.smtp_password": "Mot de passe",
    "settings.email.from_address": "Adresse d'expéditeur",
    "settings.email.use_tls": "TLS/STARTTLS",
    "settings.email.recipients": "Destinataires (séparés par virgule)",
    "settings.email.alarm_enabled": "Envoyer sur alarmes",
    "settings.email.daily_summary_enabled": "Rapport quotidien",
    "settings.email.daily_summary_time": "Heure quotidienne (HH:MM)",
    "settings.email.daily_send_now": "Envoyer maintenant",
    "settings.email.monthly_summary_enabled": "Rapport mensuel",
    "settings.email.monthly_summary_time": "Heure mensuelle (HH:MM)",
    "settings.email.monthly_send_now": "Envoyer maintenant",
    "settings.email.test": "Envoyer test",
    "settings.email.hint": "Les rapports quotidiens/mensuels sont envoyés en pièce jointe PDF.",
    "settings.alerts.col_email": "E-mail",
})
...
_I18N.setdefault("pt", {}).update({
    ...
    "settings.email.smtp_user": "Utilizador",
    "settings.email.smtp_password": "Senha",
    "settings.email.from_address": "Endereço do remetente",
    "settings.email.use_tls": "TLS/STARTTLS",
    "settings.email.recipients": "Destinatários (separados por vírgula)",
    "settings.email.alarm_enabled": "Enviar em alarmes",
    "settings.email.daily_summary_enabled": "Relatório diário",
    "settings.email.daily_summary_time": "Hora diária (HH:MM)",
    "settings.email.daily_send_now": "Enviar agora",
    "settings.email.monthly_summary_enabled": "Relatório mensal",
    "settings.email.monthly_summary_time": "Hora mensal (HH:MM)",
    "settings.email.monthly_send_now": "Enviar agora",
    "settings.email.test": "Enviar teste",
    "settings.email.hint": "Os relatórios diários/mensais são enviados como anexos PDF.",
    "settings.alerts.col_email": "E-mail",
})
...
_I18N.setdefault("it", {}).update({
    ...
    "settings.email.smtp_server": "Server SMTP",
    "settings.email.smtp_port": "Porta",
    "settings.email.smtp_user": "Nome utente",
    "settings.email.smtp_password": "Password",
    "settings.email.from_address": "Indirizzo mittente",
    "settings.email.use_tls": "TLS/STARTTLS",
    "settings.email.recipients": "Destinatari (separati da virgola)",
    "settings.email.alarm_enabled": "Invia su allarmi",
    "settings.email.daily_summary_enabled": "Report giornaliero",
    "settings.email.daily_summary_time": "Ora giornaliera (HH:MM)",
    "settings.email.daily_send_now": "Invia ora",
    "settings.email.monthly_summary_enabled": "Report mensile",
    "settings.email.monthly_summary_time": "Ora mensile (HH:MM)",
    "settings.email.monthly_send_now": "Invia ora",
    "settings.email.test": "Invia test",
    "settings.email.hint": "I report giornalieri/mensili vengono inviati come allegati PDF.",
    "settings.alerts.col_email": "E-mail",
})
...
_I18N.setdefault("pl", {}).update({
    ...
    "settings.email.smtp_server": "Serwer SMTP",
    "settings.email.smtp_port": "Port",
    "settings.email.smtp_user": "Nazwa użytkownika",
    "settings.email.smtp_password": "Hasło",
    "settings.email.from_address": "Adres nadawcy",
    "settings.email.use_tls": "TLS/STARTTLS",
    "settings.email.recipients": "Odbiorcy (oddzieleni przecinkiem)",
    "settings.email.alarm_enabled": "Wyślij przy alarmach",
    "settings.email.daily_summary_enabled": "Dzienny raport",
    "settings.email.daily_summary_time": "Godzina dzienna (HH:MM)",
    "settings.email.daily_send_now": "Wyślij teraz",
    "settings.email.monthly_summary_enabled": "Miesięczny raport",
    "settings.email.monthly_summary_time": "Godzina miesięczna (HH:MM)",
    "settings.email.monthly_send_now": "Wyślij teraz",
    "settings.email.test": "Wyślij test",
    "settings.email.hint": "Raporty dzienne/miesięczne są wysyłane jako załączniki PDF.",
    "settings.alerts.col_email": "E-mail",
})
...
_I18N.setdefault("cs", {}).update({
    ...
    "settings.email.smtp_server": "SMTP server",
    "settings.email.smtp_port": "Port",
    "settings.email.smtp_user": "Uživatelské jméno",
    "settings.email.smtp_password": "Heslo",
    "settings.email.from_address": "Adresa odesílatele",
    "settings.email.use_tls": "TLS/STARTTLS",
    "settings.email.recipients": "Příjemci (odděleni čárkou)",
    "settings.email.alarm_enabled": "Odeslat při alarmech",
    "settings.email.daily_summary_enabled": "Denní zpráva",
    "settings.email.daily_summary_time": "Denní čas (HH:MM)",
    "settings.email.daily_send_now": "Odeslat nyní",
    "settings.email.monthly_summary_enabled": "Měsíční zpráva",
    "settings.email.monthly_summary_time": "Měsíční čas (HH:MM)",
    "settings.email.monthly_send_now": "Odeslat nyní",
    "settings.email.test": "Odeslat test",
    "settings.email.hint": "Denní/měsíční zprávy jsou zasílány jako přílohy PDF.",
    "settings.alerts.col_email": "E-mail",
})
...
_I18N.setdefault("ru", {}).update({
    ...
    "settings.email.smtp_server": "SMTP-сервер",
    "settings.email.smtp_port": "Порт",
    "settings.email.smtp_user": "Имя пользователя",
    "settings.email.smtp_password": "Пароль",
    "settings.email.from_address": "Адрес отправителя",
    "settings.email.use_tls": "TLS/STARTTLS",
    "settings.email.recipients": "Получатели (через запятую)",
    "settings.email.alarm_enabled": "Отправить при тревогах",
    "settings.email.daily_summary_enabled": "Ежедневный отчёт",
    "settings.email.daily_summary_time": "Ежедневное время (ЧЧ:ММ)",
    "settings.email.daily_send_now": "Отправить сейчас",
    "settings.email.monthly_summary_enabled": "Ежемесячный отчёт",
    "settings.email.monthly_summary_time": "Ежемесячное время (ЧЧ:ММ)",
    "settings.email.monthly_send_now": "Отправить сейчас",
    "settings.email.test": "Отправить тест",
    "settings.email.hint": "Ежедневные/ежемесячные отчёты отправляются как PDF-вложения.",
    "settings.alerts.col_email": "E-mail",
})
