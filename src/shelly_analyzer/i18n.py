...
_I18N.setdefault("de", {}).update({
    ...
    "settings.email.smtp_host": "SMTP-Server",
    "settings.email.smtp_port": "Port",
    "settings.email.use_tls": "STARTTLS (empfohlen, Port 587)",
    "settings.email.use_ssl": "SSL/TLS (Port 465)",
    "settings.email.username": "Benutzername",
    "settings.email.password": "Passwort",
    "settings.email.sender": "Absender-Adresse",
    "settings.email.recipients": "Empfänger (kommagetrennt)",
    "settings.email.daily_report": "Täglicher PDF-Report (Vortag)",
    "settings.email.daily_time": "Uhrzeit",
    "settings.email.daily_send_now": "Jetzt senden",
    "settings.email.monthly_report": "Monatlicher PDF-Report (Vormonat)",
    "settings.email.monthly_time": "Uhrzeit",
    "settings.email.monthly_send_now": "Jetzt senden",
    "settings.email.test": "Test-E-Mail senden",
    "settings.email.hint": "Tägliche und monatliche PDF-Energieberichte per E-Mail (Standard-SMTP).",
})

_I18N.setdefault("en", {}).update({
    "settings.email.title": "Email Reports",
    "settings.email.enabled": "Enable email",
    "settings.email.smtp_host": "SMTP server",
    "settings.email.smtp_port": "Port",
    "settings.email.use_tls": "STARTTLS (recommended, port 587)",
    "settings.email.use_ssl": "SSL/TLS (port 465)",
    ...
    "settings.email.daily_report": "Daily PDF report (previous day)",
    "settings.email.daily_time": "Time",
    "settings.email.daily_send_now": "Send now",
    "settings.email.monthly_report": "Monthly PDF report (previous month)",
    "settings.email.monthly_time": "Time",
    "settings.email.monthly_send_now": "Send now",
    "settings.email.test": "Send test email",
    "settings.email.hint": "Daily and monthly PDF energy reports via email (standard SMTP).",
})

_I18N.setdefault("es", {}).update({
    "settings.email.title": "Informes por correo",
    "settings.email.enabled": "Activar correo",
    "settings.email.smtp_host": "Servidor SMTP",
    "settings.email.smtp_port": "Puerto",
    "settings.email.use_tls": "STARTTLS (recomendado, puerto 587)",
    "settings.email.use_ssl": "SSL/TLS (puerto 465)",
    "settings.email.username": "Usuario",
    "settings.email.password": "Contraseña",
    "settings.email.sender": "Dirección de envío",
    "settings.email.recipients": "Destinatarios (separados por coma)",
    "settings.email.daily_report": "Informe PDF diario (día anterior)",
    "settings.email.daily_time": "Hora",
    "settings.email.daily_send_now": "Enviar ahora",
    "settings.email.monthly_report": "Informe PDF mensual (mes anterior)",
    "settings.email.monthly_time": "Hora",
    "settings.email.monthly_send_now": "Enviar ahora",
    "settings.email.test": "Enviar correo de prueba",
    "settings.email.hint": "Informes PDF de energía diarios y mensuales por correo (SMTP estándar).",
})

_I18N.setdefault("fr", {}).update({
    "settings.email.title": "Rapports par e-mail",
    "settings.email.enabled": "Activer l'e-mail",
    "settings.email.smtp_host": "Serveur SMTP",
    "settings.email.smtp_port": "Port",
    "settings.email.use_tls": "STARTTLS (recommandé, port 587)",
    "settings.email.use_ssl": "SSL/TLS (port 465)",
    "settings.email.username": "Nom d'utilisateur",
    "settings.email.password": "Mot de passe",
    "settings.email.sender": "Adresse d'expéditeur",
    "settings.email.recipients": "Destinataires (séparés par virgule)",
    "settings.email.daily_report": "Rapport PDF quotidien (jour précédent)",
    "settings.email.daily_time": "Heure",
    "settings.email.daily_send_now": "Envoyer maintenant",
    "settings.email.monthly_report": "Rapport PDF mensuel (mois précédent)",
    "settings.email.monthly_time": "Heure",
    "settings.email.monthly_send_now": "Envoyer maintenant",
    "settings.email.test": "Envoyer un e-mail de test",
    "settings.email.hint": "Rapports PDF d'énergie quotidiens et mensuels par e-mail (SMTP standard).",
})

_I18N.setdefault("pt", {}).update({
    "settings.email.title": "Relatórios por e-mail",
    "settings.email.enabled": "Ativar e-mail",
    "settings.email.smtp_host": "Servidor SMTP",
    "settings.email.smtp_port": "Porta",
    "settings.email.use_tls": "STARTTLS (recomendado, porta 587)",
    "settings.email.use_ssl": "SSL/TLS (porta 465)",
    "settings.email.username": "Utilizador",
    "settings.email.password": "Senha",
    "settings.email.sender": "Endereço do remetente",
    "settings.email.recipients": "Destinatários (separados por vírgula)",
    "settings.email.daily_report": "Relatório PDF diário (dia anterior)",
    "settings.email.daily_time": "Hora",
    "settings.email.daily_send_now": "Enviar agora",
    "settings.email.monthly_report": "Relatório PDF mensal (mês anterior)",
    "settings.email.monthly_time": "Hora",
    "settings.email.monthly_send_now": "Enviar agora",
    "settings.email.test": "Enviar e-mail de teste",
    "settings.email.hint": "Relatórios PDF de energia diários e mensais por e-mail (SMTP padrão).",
})

_I18N.setdefault("it", {}).update({
    "settings.email.title": "Report via e-mail",
    "settings.email.enabled": "Abilita e-mail",
    "settings.email.smtp_host": "Server SMTP",
    "settings.email.smtp_port": "Porta",
    "settings.email.use_tls": "STARTTLS (consigliato, porta 587)",
    "settings.email.use_ssl": "SSL/TLS (porta 465)",
    "settings.email.username": "Nome utente",
    "settings.email.password": "Password",
    "settings.email.sender": "Indirizzo mittente",
    "settings.email.recipients": "Destinatari (separati da virgola)",
    "settings.email.daily_report": "Report PDF giornaliero (giorno precedente)",
    "settings.email.daily_time": "Ora",
    "settings.email.daily_send_now": "Invia ora",
    "settings.email.monthly_report": "Report PDF mensile (mese precedente)",
    "settings.email.monthly_time": "Ora",
    "settings.email.monthly_send_now": "Invia ora",
    "settings.email.test": "Invia e-mail di test",
    "settings.email.hint": "Report PDF di energia giornalieri e mensili via e-mail (SMTP standard).",
})

_I18N.setdefault("pl", {}).update({
    "settings.email.title": "Raporty e-mail",
    "settings.email.enabled": "Włącz e-mail",
    "settings.email.smtp_host": "Serwer SMTP",
    "settings.email.smtp_port": "Port",
    "settings.email.use_tls": "STARTTLS (zalecane, port 587)",
    "settings.email.use_ssl": "SSL/TLS (port 465)",
    "settings.email.username": "Nazwa użytkownika",
    "settings.email.password": "Hasło",
    "settings.email.sender": "Adres nadawcy",
    "settings.email.recipients": "Odbiorcy (oddzieleni przecinkiem)",
    "settings.email.daily_report": "Dzienny raport PDF (poprzedni dzień)",
    "settings.email.daily_time": "Godzina",
    "settings.email.daily_send_now": "Wyślij teraz",
    "settings.email.monthly_report": "Miesięczny raport PDF (poprzedni miesiąc)",
    "settings.email.monthly_time": "Godzina",
    "settings.email.monthly_send_now": "Wyślij teraz",
    "settings.email.test": "Wyślij testowy e-mail",
    "settings.email.hint": "Codzienne i miesięczne raporty PDF energii wysyłane e-mailem (standardowy SMTP).",
})

_I18N.setdefault("cs", {}).update({
    "settings.email.title": "E-mailové zprávy",
    "settings.email.enabled": "Aktivovat e-mail",
    "settings.email.smtp_host": "SMTP server",
    "settings.email.smtp_port": "Port",
    "settings.email.use_tls": "STARTTLS (doporučeno, port 587)",
    "settings.email.use_ssl": "SSL/TLS (port 465)",
    "settings.email.username": "Uživatelské jméno",
    "settings.email.password": "Heslo",
    "settings.email.sender": "Adresa odesílatele",
    "settings.email.recipients": "Příjemci (odděleni čárkou)",
    "settings.email.daily_report": "Denní zpráva PDF (předchozí den)",
    "settings.email.daily_time": "Čas",
    "settings.email.daily_send_now": "Odeslat nyní",
    "settings.email.monthly_report": "Měsíční zpráva PDF (předchozí měsíc)",
    "settings.email.monthly_time": "Čas",
    "settings.email.monthly_send_now": "Odeslat nyní",
    "settings.email.test": "Odeslat testovací e-mail",
    "settings.email.hint": "Denní a měsíční zprávy PDF o energii zasílané e-mailem (standardní SMTP).",
})

_I18N.setdefault("ru", {}).update({
    "settings.email.title": "Отчёты по e-mail",
    "settings.email.enabled": "Включить e-mail",
    "settings.email.smtp_host": "SMTP-сервер",
    "settings.email.smtp_port": "Порт",
    "settings.email.use_tls": "STARTTLS (рекомендуется, порт 587)",
    "settings.email.use_ssl": "SSL/TLS (порт 465)",
    "settings.email.username": "Имя пользователя",
    "settings.email.password": "Пароль",
    "settings.email.sender": "Адрес отправителя",
    "settings.email.recipients": "Получатели (через запятую)",
    "settings.email.daily_report": "Ежедневный PDF-отчёт (предыдущий день)",
    "settings.email.daily_time": "Время",
    "settings.email.daily_send_now": "Отправить сейчас",
    "settings.email.monthly_report": "Ежемесячный PDF-отчёт (предыдущий месяц)",
    "settings.email.monthly_time": "Время",
    "settings.email.monthly_send_now": "Отправить сейчас",
    "settings.email.test": "Отправить тестовое письмо",
    "settings.email.hint": "Ежедневные и ежемесячные PDF-отчёты об энергии по e-mail (стандартный SMTP).",
})
