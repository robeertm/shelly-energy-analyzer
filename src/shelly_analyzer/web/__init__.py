...
def _render_dashboard_html(state: "AppState") -> bytes:
    ...
    values: Dict[str, str] = {
        ...
        "web_tab_calibration": _t(lang, "web.tab.calibration"),
        "web_insights_title": _t(lang, "web.insights.title"),
        "web_tab_plots": _t(lang, "web.tab.plots"),
        "web_tab_schedule": _t(lang, "web.tab.schedule"),
        "web_tab_ev_log": _t(lang, "web.tab.ev_log"),
        "web_tab_tariff": _t(lang, "web.tab.tariff"),
        "web_tab_battery": _t(lang, "web.tab.battery"),
        "web_tab_advisor": _t(lang, "web.tab.advisor"),
        "web_tab_goals": _t(lang, "web.tab.goals"),
        "web_tab_nilm": _t(lang, "web.tab.nilm"),
        "web_tab_control": _t(lang, "web.tab.control"),
        "web_tab_sync": _t(lang, "web.tab.sync"),
