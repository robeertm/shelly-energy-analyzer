...
**Every image on this page comes from the app's own demo mode** (Settings → Demo mode, or the
setup wizard's "Try it with demo data"). The house, the meters and every number in them are
generated by the built-in simulator — no real installation, meter reading or name appears here.
...
| Consumption forecast with a confidence band. | Live grid intensity and the per-device footprint. | Meter structure and dated correction factors. |
