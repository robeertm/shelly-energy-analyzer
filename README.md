...
| The live hero: what the house draws right now, on a background whose current is that same number. | Today / week / month / year with per-device breakdown and the month projection. | A year of consumption as a calendar, plus the hour-of-day grid. |
...
| Settings |
|----------|
| ![Settings](docs/screenshots/aurora_desktop_settings.png) |
